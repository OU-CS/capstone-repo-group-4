 ...
 */
exports.getPropertyByID = async (event) => {
    ...
    const sqlStatement = 'getSinglePropertyQuery';
    const queryID = event.id;
    const sqlResponse = await databaseConnector.databaseQuery(sqlStatement, [queryID]);
